...
Public Class SmsService
    ...
    Public Shared Function StatusByUserTraceId(UserTraceIds As List(Of String)) As String
        Dim ApiKey As String = "e883424d-d70f-4e58-8ee3-4e21ea390ff1"
        Dim url As String = "http://api.sms-webservice.com/api/V3/StatusByUserTraceId"
